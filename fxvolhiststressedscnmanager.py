...
###############################################################################
class FxVolHistStressedScnManager:
    def __init__(self, 
        ...
        for currency_pair in ccy_pairs:     
            ...
            for i in range(len(stressed_dates)):
                hist_changes, quote_names = fx_vol_hist_data_manager.get_vol_matrix(currency_pair, terms, atm_inst_type, otm_inst_types, otm_inst_strikes, stressed_dates[i], data_type)
                ...
                fx_spot_rate = fx_spot_hist_stressed_scn_manager.get_fx_spot_rate(currency_pair, i)
...
if __name__ == "__main__":
    ...
    fx_vol_surf_stressed_manager = FxVolHistStressedScnManager(as_of_date, sim_date, stressed_dates, change_type, liquidity_horizon,
                 fx_vol_surf_template_manager,
                 fx_option_mkt_convention_manager,
                 fx_vol_hist_data_manager,
                 fx_spot_hist_stressed_scn_manger,
                 ir_yield_curve_hist_stressed_scn_manager)   
    print(fx_vol_surf_stressed_manager.fx_vol_surfs)