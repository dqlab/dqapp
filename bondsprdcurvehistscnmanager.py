...
###############################################################################            
class BondSprdCurveHistScnManager:
    def __init__(self, as_of_date, sime_date, num_sims, change_type, liquidity_horizon,
                 ...
                 benchmark_bond_template_manager, bond_yield_curve_hist_scn_manager):
        ...
        for curve_name in bond_sprd_curve_template_manager.curve_names:
            ...
            for i in range(num_sims):
                ...
                base_curve = bond_yield_curve_hist_scn_manager.get_yield_curve(base_curve_name,i)
...
if __name__ == "__main__":
    ...
    print('bond yield curves:', bond_sprd_curve_hist_scn_manager.sprd_curves)    
